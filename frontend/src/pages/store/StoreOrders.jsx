  ...
  return (
    <>
      <div className="page-header">
        <h1 className="page-title">{t('orders.storeTitle')}</h1>
        <p className="page-subtitle">{t('orders.storeSubtitle')}</p>
      </div>
        ...
        {orders.length === 0 ? (
          <div className="card">
            <div className="empty-state">
              ...
              <p>{t('orders.noStoreOrders')}<br />{t('orders.noStoreOrdersSub')}</p>
            </div>
          </div>
        ) : (
          orders.map((order) => {
